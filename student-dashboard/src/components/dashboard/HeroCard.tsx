...
import { Flame, Sparkles, Trophy, ArrowUpRight } from "lucide-react";

export default function HeroCard() {
  // Current streak details
  const streak = 14;
  const rankProgress = 85; // 85% to next level
      ...
      <div className="relative z-10 flex justify-between items-start">
        <div className="space-y-1.5 md:space-y-2">
          ...
          <h1 className="text-2xl md:text-3xl font-black tracking-tight text-white leading-tight mt-1">
            Welcome back, <span className="bg-clip-text text-transparent bg-gradient-to-r from-accent-purple to-accent-cyan">Khush</span>
          </h1>
          <p className="text-xs md:text-sm text-zinc-400 max-w-md font-medium">
